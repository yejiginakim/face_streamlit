...
class FaceShapeModel:
    ...
    def _load_checkpoint(self, model_path: str):
        ...
        try:
            ...
            # 2차: safe_mode=False + custom_objects
            try:
                ...
                raise RuntimeError(
                    ...
                    "Tip: Save & load with tf.keras; avoid standalone keras mismatch."
                )

    def _preprocess_pil(self, pil_img: Image.Image):
        pil_resized = pil_img.resize(self.img_size)
        arr = tfk.utils.img_to_array(pil_resized)[None, ...]
